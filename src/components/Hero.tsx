        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Button
              ...
              className="h-12 sm:h-14 md:h-16 w-full sm:w-auto px-6 sm:px-8 md:px-10 bg-primary hover:bg-white-dim text-navy font-bold text-sm sm:text-base md:text-lg rounded-xl sm:rounded-r-xl  shadow-lg whitespace-nowrap min-w-[100px] sm:min-w-[120px] cursor-pointer relative z-10"
            >
              Get instant quote
